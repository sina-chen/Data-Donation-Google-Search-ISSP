...
To test the Python code without clicking through the UI, you can run the unit tests:
...
End-to-end tests (with an actual browser) are also included via Playwright.
